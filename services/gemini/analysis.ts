...
- **new_stages**: 一个数组。每个阶段对象的字段全部平铺（不要嵌套子对象）：
  ...
  - relations: 关系数组 [{"target":"对象名","attitude":"态度"}]
...
{"characterUpdates":[{"static_profile":{"name":"角色名","gender":"男/女","origin":"籍贯","role":"男主/配角","bio":"简介"},"new_stages":[{"stage_name":"阶段名","text_range":"第X章-第Y章","chapter_start":1,"chapter_end":1,"appearance":"","physical_state":"","signature_props":"","core_goal":"","speaking_style":"","personality_tags":[""],"relations":[{"target":"","attitude":""}]}]}]}`;
